...
PRODUCT_DTB_TARGET := kernel/arch/arm64/boot/dts/rockchip/rk3566-odroid-m1s.dtb
PRODUCT_DTBO_TARGET := kernel/arch/arm64/boot/dts/rockchip/overlays/odroidm1s/*.dtbo
...
PRODUCT_PROPERTY_OVERRIDES += persist.systembar.volume.hide=false
